...
public:
	...
	enum class RangeRemapMode { Absolute, Proportional };
	...
	DECLARE_ASYNC_EVENT(Automation, Automation, automation, ENUM_LIST(INTERACTIVE_SIMPLIFICATION_CHANGED), EVENT_INSPECTABLE_CHECK)
